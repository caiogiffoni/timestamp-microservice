...
pode até botar pra editar se quiserpode até botar pra editar se quiserpode até botar pra editar se quiser
yarn add express-async-errors
importar no app express-async-errors e sempre deicar acima nos imports
fazer middleware, chamar app.use ndo middleware e criar pasta error e fazer extend do error para appError
deixar o app.use mais abaixo

request properties mudar o @types/express. Mudando a interface eo type roots no tsconfig.ts
